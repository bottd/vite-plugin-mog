...
An ``text: embed:react`` block drops a real component into the document. This
one is ``text: src/components/Counter.tsx``, found by ``text: componentDir``:
...
``embed:react:
<p className="mog-note">Styled by this document's own CSS.</p>
``
